...
class Kategori(models.Model):
    ...
    banner_satu = models.ImageField(
        upload_to='gambar/banner', blank=False, null=True, verbose_name="Gambar Banner (575 x 200 pixel)")
    # banner_satu = ResizedImageField(size=[575, 200], quality=80, crop=[
    #                                 'middle', 'center'], upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar 1 (575 x 200 pixel)")
    banner_dua = models.ImageField(
        upload_to='gambar/banner', blank=False, null=True, verbose_name="Gambar 2 (575 x 200 pixel)")
...
class Produk(models.Model):
    ...
    kategori = models.ForeignKey(
        Kategori, null=True, blank=True, related_name="produks", on_delete=models.SET_NULL)
    nama_produk = models.CharField(max_length=200, blank=True, null=True)
    gambar = models.ImageField(upload_to='gambar/banner', blank=False,
                               null=True, verbose_name="Gambar (640 x 640 pixel)")
    gambar_satu = models.ImageField(
        upload_to='gambar/banner', blank=False, null=True, verbose_name="Gambar (270 x 250 pixel)")
    ...
    keterangan_barang = models.CharField(
        max_length=200, null=True, choices=KETERANGAN)
...
class Slide(models.Model):
    ...
    gambar_slide = models.ImageField(
        upload_to='gambar/slide', blank=False, null=True, verbose_name="Gambar Slide (475 x 880 pixel)")
    aktif = models.BooleanField(default=True)
